...
function initDataBase() {
    ...
    if (!localStorage.menu || !localStorage.childMenu || !localStorage.task) {
        ...
        var taskJson = [{
            ...
            'by Chenxuanwei<br><ul><li><a href="http://www.jianshu.com/u/e73691f972bb">简书</a></li><li><a href="https://github.com/jokerchangit">GitHub</a></li><li><a href="http://mail.163.com/">邮箱</a></li></ul>'
        }
        ];
        // DataBase init本地缓存
